...
<body data-page="system">
  ...
  <script>
    (() => {
      ...
      const urls = { hub: `http://${host}:8191/`, queue: `http://${host}:11435/status`, system: `http://${host}:8008/`, vision: `http://${host}:8003/`, voice: `http://${host}:8002/`, docs: `http://${host}:8004/`, video: `http://${host}:8005/`, coder: `http://${host}:8006/`, auto: `http://${host}:8007/`, whisper: `http://${host}:8000/`, workspace: `http://${host}:8001/?workspace=1`, comfy: `http://${host}:8188/` };
